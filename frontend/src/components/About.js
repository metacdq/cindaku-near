        ...
        <div className="uk-container">
            <header className="uk-grid-xsmall uk-flex-center uk-flex-middle uk-grid" data-uk-grid data-anime="opacity:[0, 1]; translateY:[24, 0]; onview: true; delay: 100;">
                <div className="uk-panel uk-text-center">
                    <h2 className="uk-h3 uk-h1@m">About NFT AR</h2>
                </div>
            </header>
                            ...
                            <div className="uk-grid uk-grid-3xlarge@m uk-flex-middle uk-child-width-1-2@m" data-uk-grid="">
                                ...
                                <div>
                                    <div className="uk-panel" data-anime="opacity:[0, 1]; translateX:[24, 0]; onview: -250; delay: 300;">
                                        <span className="uk-text-overline uk-text-gradient">Mint, Play & Share</span>
                                        <h3 className="uk-h3 uk-h1@m">Mint your own NFT Fashion AR</h3>
                                        <p className="uk-text-large@m">Collect Hundreds Of Unique NFT AR & Dozens Of Free AR Effects.</p>
                                        <div className="uk-grid uk-grid-large@m uk-grid-match uk-child-width-1-2 uk-margin-large-top@m" data-uk-grid="">
                                            <div>
                                                <div className="uk-panel">
                                                    <h5 className="uk-h4 uk-h2@m uk-margin-xsmall">200+</h5>
                                                    <span className="uk-text-small@m"
                                                        >Unique AR Effects</span>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="uk-panel">
                                                    <h5 className="uk-h4 uk-h2@m uk-margin-xsmall">5+</h5>
                                                    <span className="uk-text-small@m">Social Media Connected</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
