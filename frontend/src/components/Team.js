                                    ...
                                    <div className="uni-artist-avatar uk-grid uk-grid-collapse uk-child-width-1-1 uk-flex-middle" data-uk-grid>
                                        <div>
                                            <div className="uk-panel uk-overflow-hidden">
                                                <img className="uk-cover uk-radius-medium uk-radius-large@m" src="https://static.cindaku.com/images/users/02.png" alt="Steph Jobs" data-uk-cover/>
                            ...
                            <div className="uk-padding-medium-top@m">
                                <div className="uni-artist uk-panel uk-overflow-hidden uk-card uk-card-2xsmall uk-radius-large uk-radius-xlarge@m uk-box-shadow-xsmall dark:uk-background-white-5">
                                    <div className="uni-artist-avatar uk-grid uk-grid-collapse uk-child-width-1-1 uk-flex-middle" data-uk-grid>
                                        <div>
                                            <div className="uk-panel uk-overflow-hidden">
                                                <img className="uk-cover uk-radius-medium uk-radius-large@m" src="https://static.cindaku.com/images/users/03.png" alt="Andry Moray" data-uk-cover/>
                                                <canvas width="400" height="400"></canvas>
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div>
                                <div className="uni-artist uk-panel uk-overflow-hidden uk-card uk-card-2xsmall uk-radius-large uk-radius-xlarge@m uk-box-shadow-xsmall dark:uk-background-white-5">
                                    <div className="uni-artist-avatar uk-grid uk-grid-collapse uk-child-width-1-1 uk-flex-middle" data-uk-grid>
                                        <div>
                                            <div className="uk-panel uk-overflow-hidden">
                                                <img className="uk-cover uk-radius-medium uk-radius-large@m" src="https://static.cindaku.com/images/users/01.png" alt="Zaid Ed" data-uk-cover/>
                                                <canvas width="400" height="400"></canvas>
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div className="uk-padding-medium-top@m">
                                <div className="uni-artist uk-panel uk-overflow-hidden uk-card uk-card-2xsmall uk-radius-large uk-radius-xlarge@m uk-box-shadow-xsmall dark:uk-background-white-5">
                                    <div className="uni-artist-avatar uk-grid uk-grid-collapse uk-child-width-1-1 uk-flex-middle" data-uk-grid>
                                        <div>
                                            <div className="uk-panel uk-overflow-hidden">
                                                <img className="uk-cover uk-radius-medium uk-radius-large@m" src="https://static.cindaku.com/images/users/04.png" alt="Laila Ed" data-uk-cover/>
                                                <canvas width="400" height="400"></canvas>
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div>
                                <div className="uni-artist uk-panel uk-overflow-hidden uk-card uk-card-2xsmall uk-radius-large uk-radius-xlarge@m uk-box-shadow-xsmall dark:uk-background-white-5">
                                    <div className="uni-artist-avatar uk-grid uk-grid-collapse uk-child-width-1-1 uk-flex-middle" data-uk-grid>
                                        <div>
                                            <div className="uk-panel uk-overflow-hidden">
                                                <img className="uk-cover uk-radius-medium uk-radius-large@m" src="https://static.cindaku.com/images/users/05.png" alt="John Clark" data-uk-cover/>
                                                <canvas width="400" height="400"></canvas>
                                            </div>
                                        </div>
                                        <div>
