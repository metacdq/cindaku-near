        ...
        <div
            ...
            <div className="uk-container">
                ...
                >
                    ...
                    <div className="swiper-slide">
                        ...
                        <div className="uni-phase uk-panel uk-overflow-hidden uk-card uk-card-small uk-card-medium@m uk-radius uk-radius-xlarge@m uk-box-shadow-xsmall dark:uk-background-white-5">
                            ...
                            <ul className="uk-list uk-text-small uk-text-medium@m">
                                ...
                                <i className="uk-icon uk-icon-xsmall uk-icon-small@m unicon-checkmark-outline uk-margin-xsmall-right uk-text-gradient" />{" "}
                    ...
                    <div className="swiper-pagination swiper-pagination-progressbar swiper-pagination-horizontal swiper-dotnav" />
                </div>
                <a
                    aria-label="Next"
                    href="#next"
                ...
                >
                    <i className="uk-icon-small" data-feather="chevron-right" />
                </a>
                <a
                    aria-label="Prev"
                    href="#prev"
                ...
                >
                    <i className="uk-icon-small" data-feather="chevron-left" />
                </a>
                </div>
            </div>
            </div>
